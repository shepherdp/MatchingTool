...
const CookieNotice=()=> {
  ...
  return (
    <section className='fixed w-[30%] h-[20%] z-50 bg-black top-[75%] left-[1%] opacity-[60%] flex flex-col justify-center place-items-center text-center text-white rounded-lg'>
