            ...
            <main className="min-h-screen">
                ...
                <div className="relative min-h-screen h-screen bg-[#E6F3FE]">
                        <div className="absolute w-[60%] h-[60%] top-[22%] left-[20%] bg-[#4169E1]">
                            <div className="relatice bg-[#4169E1] w-full h-full">
                                <div className="absolute flex flex-col place-items-center justify-center bg-white w-full h-full -left-[3%] -top-[3%] lg:justify-between lg:flex-row lg:-left-[1.5%]">
                                    <div className="w-[70%] flex flex-col lg:w-[20%] lg:place-content-center lg:ml-4">
                                            
                                        <div className=" text-gray-700 mb-2">
                                            <label htmlFor="add">Add Participants</label>
                                        </div>
                                        <input className="bg-[#E6F3FE] border-b-2 border-[#4169E1] text-gray-700 pl-2 lg:w-52 outline-none" type="text" name="add" placeholder="participant's name..." value={newMember} 
                                        ...
                                        <button type='button' onClick={()=>{newMember.length > 0 && 
                                            ...
                                            )}} className=" bg-[#4169E1] text-center mb-2 lg:w-52 text-white" >Add</button>
                                    </div>
                                    <div className="w-[70%] max-h-[30%] overflow-auto cursor-default lg:mt-6 mb-4 lg:w-[60%] lg:max-h-[50%]">
                                        {
                                            members.length > 0 
                                            &&
