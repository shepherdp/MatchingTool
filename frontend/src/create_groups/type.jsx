                    ...
                    <form className="bg-[#E6F3FE] flex justify-center w-1/2 absolute top-1/4 lg:w-max">
                            <div className="flex items-center justify-center -space-x-[460px] -space-y-[16px] pt-[10px] bg-[#E6F3FE] shadow-xl lg:-space-x-[912px] lg:-space-y-[22px]">
                                <div className="w-[450px] h-[520px] bg-[#4169E1] lg:w-[900px] rounded-lg"></div>
                                    <div className="relative w-[450px] h-[520px] bg-white flex flex-col items-center justify-center lg:w-[900px] rounded-lg shadow-lg shadow-[#4169E1]">
                                    ...
                                    <div className="flex flex-row">
                                        <div className="absolute top-[50%] left-[19%] lg:left-[30%]">
                                            <button type="button" onClick={()=>{setIsOpen((prev)=>!prev)}} className="h-12 w-52 flex justify-between pl-2 pr-2 items-center bg-[#E6F3FE] border-b-2 border-[#4169E1] lg:w-64 rounded-l-lg shadow-md shadow-[#4169E1]">
                                            {selected}
                                            ...
                                            </button>
                                            {
                                                isOpen
                                                 && 
                                                <div className="w-[266px] h-32 border-t-2 border-b-2 cursor-default mb-4 lg:w-[313px] lg:h-[200px] rounded-r-lg overflow-auto mt-2">
                                                    <ul className="text-black flex flex-col items-center mb-2 gap-y-2">
                                                        {options.map((member, i) => (
                                                            <button type="button" onClick={()=>{
                                                                setSelected(member)
                                                                setIsOpen((prev)=>!prev)
                                                            }} key={i}  className="w-full h-12 bg-[#E6F3FE] border-b-2 border-[#4169E1] flex justify-center place-items-center pl-4 gap-2 rounded-lg shadow-md shadow-[#4169E1] ">
