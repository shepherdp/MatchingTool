            ...
            <ul className="min-w-full max-h-screen overflow-x-hidden flex flex-wrap gap-4 justify-center lg:justify-start lg:pl-12 lg:pr-12 pb-6 pt-6 lg:gap-8 lg:pt-24">
              <li>
                <button
                  ...
                  className="relative"
                >
                  <div className="w-[200px] h-[200px] lg:w-[250px] lg:h-[250px] bg-white border-4 border-[#4169E1] flex justify-center items-center text-[#4169E1] text-[90px] hover:text-[100px] rounded-lg shadow-lg shadow-[#a1a2a7]">
                    <BiPlusMedical />
                  </div>
                </button>
              </li>
