            ...
            <div className="absolute bg-[#4169E1] w-[60%] h-[70%] top-[16%] left-[22%]">
                <div className="absolute flex flex-col place-items-center pt-6 gap-y-8 bg-white w-full h-full -top-[1%] -left-[2%] lg:-top-[2%] lg:-left-[1.5%]">
                    <div className="relative w-full h-full">
                        <div className="flex flex-col h-[30%] w-[100%] place-items-center pt-6 gap-y-8 ">
                            <div className="w-[50%] h-[30%]">
                                <h1>Activity Name</h1>
                                <input onChange={(e) => setName(e.target.value)} className="bg-[#E6F3FE] text-gray-700 w-[100%] h-[100%] outline-none pl-2 border-b-2 border-[#4169E1] lg:w-64" type="text" />
                            </div>
                            <div className="w-[50%] h-[30%]">
                                <h1>Team Size</h1>
                                <input onChange={(e)=> setSize(e.target.value)} className="bg-[#E6F3FE] text-gray-700 w-[100%] h-[100%] outline-none pl-2 border-b-2 border-[#4169E1] lg:w-64" type="text" />
                            </div>
