            ...
            <div className="absolute bg-[#4169E1] w-[80%] left-[11%] lg:w-[60%] h-[70%] top-[16%] lg:left-[22%] rounded-lg">
                <div className="absolute flex flex-col place-items-center pt-6 gap-y-8 bg-white w-full h-full -top-[1%] -left-[2%] lg:-top-[2%] lg:-left-[1.5%] rounded-lg shadow-lg shadow-[#4169E1]">
                    <form onSubmit={
                        ...
                        <div className="relative flex flex-col h-[50%] w-[100%] place-items-center pt-6 gap-y-6">
                            <div className="flex flex-col w-[100%] h-[25%] justify-center place-items-center">
                                <h1>Activity Name</h1>
                            ...
                            <div className="flex flex-col w-[100%] h-[30%] justify-center place-items-center">
                                <h1 className="absolute top-[67%]" style={{ transform: 'translateY(25%)' }}>Matching Options</h1>
                                <div ref={optionsRef} className="w-[100%] flex justify-center place-items-center">
                                    ...
                                    }} className="absolute h-[14%] w-[70%] lg:w-[28%] flex justify-between pl-6 items-center bg-[#E6F3FE] border-b-2 border-[#4169E1] rounded-lg shadow-md shadow-[#4169E1]">
