      ...
      <main className="min-h-screen">
        ...
        <div className='relative w-full h-full rounded-lg shadow-2xl'>
            ...
            <h1 className='text-[#4169E1]'>MAKER</h1>
              ...
              <button type='submit' disabled={submitted} className='bg-[#4169E1] font-semibold w-[60%] h-[10%] lg:h-[13%] text-white rounded-lg'>{!submitted ? <>Register</> : <><FaSpinner className='animate-spin font-extrabold text-2xl text-center text-white'/> <h1>Loading...</h1></>}</button>
            </form>
